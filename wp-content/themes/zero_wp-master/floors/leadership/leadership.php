    ...
    <div class="leadership__wrapper base_wrapper">
        ...
        <div class="leadership__cards-wrapper small_wrapper">
            ...
            <!-- <div class="leadership__card card">
                <div class="card__photo-wrapper">
                    <div class="card__circle-bg"></div>
                    <img class="card__photo" src="http://localhost:8888/gp_solutions/wp-content/uploads/2025/07/rodion.png" alt="Rodion">
                    <div class="card__circle-border"></div>
                </div>

                <div class="card__socials">
                    <img class="card__linkedin" src="http://localhost:8888/gp_solutions/wp-content/uploads/2025/07/linkedin.svg">
                    <img class="card__arrow" src="http://localhost:8888/gp_solutions/wp-content/uploads/2025/07/arrrow-bigger.svg">
                </div>

                <div class="card__info">
                    <h4>Rodion Zhitomirsky</h4>
                    <p>Chairman of the Board,<br>Co-founder</p>
                </div>
            </div>
